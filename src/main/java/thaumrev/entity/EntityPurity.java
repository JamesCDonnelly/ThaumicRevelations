...
//	}
    ...
    public void onUpdate() {
        if (worldObj.isRemote) {
            for (int i = 0; i < 3; i++) {
                Thaumcraft.proxy.wispFX2(worldObj,
                        posX + (worldObj.rand.nextFloat() - worldObj.rand.nextFloat()) * 0.2F,
                        posY + (worldObj.rand.nextFloat() - worldObj.rand.nextFloat()) * 0.2F,
                        posZ + (worldObj.rand.nextFloat() - worldObj.rand.nextFloat()) * 0.2F,
                        0.3F, 2, true, false, 0.02F
                );
