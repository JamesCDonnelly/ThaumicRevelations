...
import thaumrev.item.armour.ItemWardenBoots;
...
public class ThaumRevContent {
	...
	public static void loadResearch() {
		...
		researchTWarden = new ThaumRevResearchItem(
				"TREVELATIONS",
				"trevelations",
		...
		researchQuartz = new ThaumRevResearchItem(
				...
				2, 0, 2,
				new ItemStack(itemResource, 0, 2)).setParents("TREVELATIONS").setRound().registerResearchItem();
		...
		researchCrystal = new ThaumRevResearchItem(
				...
				new AspectList().add(EXCUBITOR, 4).add(Aspect.CRYSTAL, 4),
				-2, 0, 2,
				new ItemStack(itemResource, 0, 1)).setParents("TREVELATIONS").setSecondary().registerResearchItem();
		...
		researchWaslieHammer = new ThaumRevResearchItem(
				...
				new AspectList().add(EXCUBITOR, 4).add(Aspect.CRYSTAL, 4),
				4, 4, 3,
				new ItemStack(itemWaslieHammer)).setParentsHidden("CRYSTAL", "QUARTZ").setParents("LORE4").setRound().setSpecial().registerResearchItem();
		...
		researchLore1 = new ThaumRevResearchItem(
				...
				0, 2, 3,
				new ItemStack(itemWardenAmulet)).setParents("TREVELATIONS").setRound().setSpecial().registerResearchItem();
		...
		researchLore2 = new ThaumRevResearchItem("LORE2", "trevelations",
				new AspectList().add(EXCUBITOR, 4).add(Aspect.MIND, 4),
				-2, 4, 3,
				new ItemStack(itemWardenAmulet)).setParents("LORE1").setRound().setSpecial().registerResearchItem();
		...
		researchLore3 = new ThaumRevResearchItem(
				...
				new AspectList().add(EXCUBITOR, 4).add(Aspect.MIND, 4),
				0, 6, 3,
				new ItemStack(itemWardenAmulet)).setParents("LORE2").setRound().setSpecial().registerResearchItem();
		...
		researchLore4 = new ThaumRevResearchItem(
				...
				new AspectList().add(EXCUBITOR, 4).add(Aspect.MIND, 4),
				2, 4, 3,
				new ItemStack(itemWardenAmulet)).setParents("LORE3").setRound().setSpecial().registerResearchItem();
