...
import thaumrev.item.crafting.RecipesThaumRevArmorDyes;
...
public final class ConfigRecipes {
  public static void registerRecipes() {
    if (ConfigIntegrations.isThaumicBasesLoaded) {
      loadThaumicDyesIntegrationRecipies();
    }
  ...
  private static void loadShapedRecipes() {
    ...
    GameRegistry.addShapedRecipe(
      ...
      "X", "X",
      'X', new ItemStack(blockSlabInfusedQuartz)
    );
    ...
    GameRegistry.addShapedRecipe(
      new ItemStack(blockSlabInfusedQuartz, 6),
      "XXX",
      'X', new ItemStack(blockInfusedQuartzNormal)
    );
  ...
  private static void loadCrucibleRecipes() {
    ...
    if (!ConfigIntegrations.isThaumicDyesLoaded) {
  ...
  private static void loadWardenRecipes() {
    recipeWardenclothChest = ThaumcraftApi.addArcaneCraftingRecipe(
      "WARDENCLOTH",
      new ItemStack(itemWardenclothChest),
      new AspectList()
        .add(Aspect.ORDER, 8)
    ...
    recipeWardenclothLegs = ThaumcraftApi.addArcaneCraftingRecipe(
      "WARDENCLOTH",
      new ItemStack(itemWardenclothLegs),
      new AspectList()
        .add(Aspect.ORDER, 7)
    ...
    recipeWardenAmulet = ThaumcraftApi.addArcaneCraftingRecipe(
      "WARDENAMULET",
      new ItemStack(itemWardenAmulet, 1, 2),
      new AspectList()
  ...
  private static void loadCrimsonRecipes() {
    ItemStack crimsonCloth = ConfigIntegrations.isThaumicDyesLoaded
  ...
  private static void loadThaumicDyesIntegrationRecipies() {
    GameRegistry.addRecipe(new RecipesThaumRevArmorDyes());
  }
}
